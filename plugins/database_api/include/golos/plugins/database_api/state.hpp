...
//FC_REFLECT((golos::plugins::database_api::state), (current_route)(props)(tag_idx)(tags)(content)(accounts)(pow_queue)(witnesses)(witness_schedule)(feed_price)(error)(market_data))
