 ...
 */
        ...
        private:
            ...
            static bool filter_default(const comment_object &c) {
                return false;
            }

            static bool exit_default(const comment_object &c) {
                return false;
            }
            ...
            vector<discussion> metadata_filter(const vector<discussion> &discussions,
