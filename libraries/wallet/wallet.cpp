        ...
        namespace detail {
            ...
            public:
                ...
                wallet_api_impl( wallet_api& s, const wallet_data& initial_data, const golos::protocol::chain_id_type& _steem_chain_id, fc::api_connection& con ):
                    ...
                    _remote_operation_history( con.get_remote_api< golos::wallet::remote_operation_history >( 0, "operation_history" ) ),
                    _remote_account_history( con.get_remote_api< golos::wallet::remote_account_history >( 0, "account_history" ) ),
